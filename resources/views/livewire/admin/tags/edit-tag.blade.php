<div>
    ...
    <form wire:submit="save">
        ...
        <div class="mt-4">
         ...
         hint="Select your favorite color or insert a hexadecimal value." wire:model.blur="form.text_color" :colors="['#ffffff', '#000000', '#991b1b', '#a8f312', '#fdad41', '#a230a3', '#6b21a8', '#166534', '#3f6212']" />

        </div>

        <div class="mt-4">
            <x-color label="Background Color" :colors="['#1e40af', '#ef4444', '#991b1b', '#a8f312', '#fdad41', '#a230a3', '#6b21a8', '#166534', '#3f6212']"
